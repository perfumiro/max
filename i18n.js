...
(function () {
    ...
    const dict = {
        ...
        'index.flash_stock_badge':        { fr: '<span aria-hidden="true" style="font-size:0.75rem;line-height:1;">✦</span> Édition Limitée' },
        'index.flash_stock_only':         { fr: 'SEULEMENT' },
        'index.flash_stock_left':         { fr: 'EN STOCK' },
        'index.flash_stock_selling_fast': { fr: 'Ventes rapides — ne ratez pas !' },
        'index.flash_stock_viewers_init': { fr: '14 personnes consultent en ce moment' },
        ...
        'login.rp_title':       { fr: 'Réinitialiser le mot de passe' },
        'login.rp_sub':         { fr: 'Entrez votre email et nous vous enverrons un lien de réinitialisation.' },
        'login.rp_placeholder': { fr: 'Votre adresse email' },
        'login.rp_send':        { fr: 'Envoyer le lien' },
        ...
        /* ===== LOGIN PAGE — form strings ===== */
        'login.form_title':        { fr: 'Bon retour parmi nous' },
        'login.form_subtitle':     { fr: 'Connectez-vous à votre compte IPORDISE.' },
        'login.signup_heading':    { fr: 'Créez votre compte' },
        'login.signup_subheading': { fr: 'Rejoignez IPORDISE — en une minute seulement.' },
        'login.first_name':        { fr: 'Prénom' },
        'login.first_name_ph':     { fr: 'Prénom' },
        'login.last_name':         { fr: 'Nom' },
        'login.last_name_ph':      { fr: 'Nom' },
        'login.password_min':      { fr: 'Min. 6 caractères' },
        'login.confirm_password':  { fr: 'Confirmer le mot de passe' },
        'login.confirm_password_ph':{ fr: 'Répéter le mot de passe' },
        'login.google_btn':        { fr: 'Continuer avec Google' },
        'login.apple_btn':         { fr: 'Continuer avec Apple' },
        'login.or':                { fr: 'ou' },
        'login.no_account':        { fr: 'Pas encore de compte ?' },
        'login.create_one':        { fr: 'Créer un compte' },
        'login.have_account':      { fr: 'Vous avez déjà un compte ?' },
        'login.existing_account_btn': { fr: 'Se connecter' },
        'login.secure_badge':      { fr: 'Protégé par Firebase Authentication' },

        /* ===== DASHBOARD PAGE ===== */
        'dashboard.announce':         { fr: "Emballage cadeau offert &mdash; Code&nbsp;: <span class=\"top-announcement-code\">PARFUM15</span> &mdash; <a href=\"../discover.html?filter=all\" class=\"top-announcement-link\">ACHETER&nbsp;!</a>" },
        'dashboard.my_account':       { fr: 'Mon Compte' },
        'dashboard.orders':           { fr: 'Commandes' },
        'dashboard.wishlist':         { fr: 'Favoris' },
        'dashboard.vip_member':       { fr: 'Membre VIP' },
        'dashboard.shop_now':         { fr: 'Acheter' },
        'dashboard.sign_out':         { fr: 'Se déconnecter' },
        'dashboard.navigation':       { fr: 'Navigation' },
        'dashboard.nav_overview':     { fr: 'Aperçu' },
        'dashboard.nav_profile':      { fr: 'Mon Profil' },
        'dashboard.nav_my_profile':   { fr: 'Mon Profil' },
        'dashboard.nav_orders':       { fr: 'Commandes' },
        'dashboard.nav_my_orders':    { fr: 'Mes Commandes' },
        'dashboard.nav_track':        { fr: 'Suivre un Colis' },
        'dashboard.nav_addresses':    { fr: 'Adresses' },
        'dashboard.nav_support':      { fr: 'Assistance' },
        'dashboard.nav_returns':      { fr: 'Retours' },
        'dashboard.nav_quick':        { fr: 'Actions rapides' },
        'dashboard.account_overview': { fr: 'Aperçu du Compte' },
        'dashboard.browse_collection':{ fr: 'Parcourir la collection \u2192' },
        'dashboard.my_favourites':    { fr: 'Mes Favoris' },
        'dashboard.browse_catalogue': { fr: 'Parcourir le catalogue \u2192' },
        'dashboard.recent_orders':    { fr: 'Commandes R\u00e9centes' },
        'dashboard.track_order_link': { fr: 'Suivre la commande \u2192' },
        'dashboard.quick_actions':    { fr: 'Actions Rapides' },
        'dashboard.orders_desc':      { fr: 'Suivez vos commandes ouvertes et pass\u00e9es.' },
        'dashboard.view_orders':      { fr: 'Voir les commandes' },
        'dashboard.wishlist_desc':    { fr: 'Fragrances sauvegard\u00e9es pour plus tard.' },
        'dashboard.member_status':    { fr: 'Statut Membre' },
        'dashboard.member_desc':      { fr: 'Acc\u00e8s anticip\u00e9 exclusif & offres.' },
        'dashboard.best_sellers':     { fr: 'Meilleures ventes' },
        'dashboard.live':             { fr: 'En direct' },
        'dashboard.delivery':         { fr: 'Livraison' },
        'dashboard.delivery_desc':    { fr: 'Suivez chaque exp\u00e9dition en temps r\u00e9el.' },
        'dashboard.track_parcel':     { fr: 'Suivre un colis' },
        'dashboard.promo_eyebrow':    { fr: 'Offre limit\u00e9e' },
        'dashboard.promo_title':      { fr: 'D\u00e9couvrez les Nouveaut\u00e9s' },
        'dashboard.promo_sub':        { fr: "Utilisez le code <strong style=\"color:#fff;\">PARFUM15</strong> pour 15% sur votre prochaine commande." },
        'dashboard.profile_personal': { fr: 'Informations personnelles & pr\u00e9f\u00e9rences' },
        'dashboard.display_name':     { fr: "Nom d\u2019affichage" },
        'dashboard.display_name_ph':  { fr: 'Votre nom complet' },
        'dashboard.email_address':    { fr: 'Adresse email' },
        'dashboard.phone':            { fr: 'Num\u00e9ro de t\u00e9l\u00e9phone' },
        'dashboard.city':             { fr: 'Ville' },
        'dashboard.city_ph':          { fr: 'Casablanca, Rabat, Tanger\u2026' },
        'dashboard.save_changes':     { fr: 'Sauvegarder' },
        'dashboard.saved_ok':         { fr: 'Sauvegard\u00e9 avec succ\u00e8s\u00a0!' },
        'dashboard.no_orders':        { fr: 'Aucune commande pour l\u2019instant' },
        'dashboard.no_orders_desc':   { fr: "Vous n\u2019avez pas encore pass\u00e9 de commande.<br>Explorez notre collection de fragrances." },
        'dashboard.discover_fragrances':{ fr: 'D\u00e9couvrir les fragrances' },
        'dashboard.qa_addresses':     { fr: 'Adresses de livraison' },
        'dashboard.qa_addresses_desc':{ fr: 'G\u00e9rez vos adresses d\u2019exp\u00e9dition enregistr\u00e9es.' },
        'dashboard.qa_support':       { fr: 'Assistance & Conciergerie' },
        'dashboard.qa_support_desc':  { fr: 'Obtenez l\u2019aide de nos conseillers fragrance.' },
        'dashboard.qa_returns':       { fr: 'Retours & Remboursements' },
        'dashboard.qa_returns_desc':  { fr: 'Demandez un retour ou v\u00e9rifiez un remboursement.' },
        'dashboard.qa_track':         { fr: 'Suivre ma commande' },
        'dashboard.qa_track_desc':    { fr: 'Suivez chaque \u00e9tape de votre exp\u00e9dition.' },
        'dashboard.qa_faq':           { fr: 'FAQ' },
        'dashboard.qa_faq_desc':      { fr: 'R\u00e9ponses aux questions fr\u00e9quentes.' },
        'dashboard.qa_newsletter':    { fr: 'Newsletter' },
        'dashboard.qa_newsletter_desc':{ fr: 'Abonnez-vous pour des offres exclusives.' },
        'dashboard.nav_favourites':    { fr: 'Mes Favoris' },
        'dashboard.nav_settings':      { fr: 'Param\u00e8tres' },
        ...
        'product.ondemand_title':      { fr: 'Rupture de stock' },
        'product.ondemand_sub':        { fr: 'Ce produit est actuellement en rupture de stock. Sélectionnez une taille et appuyez sur « Demander sur WhatsApp » pour être notifié dès son retour.' },
        'product.ask_whatsapp':        { fr: 'Demander sur WhatsApp' },
        'product.ask_whatsapp_sub':    { fr: 'Prix et disponibilité — réponse en quelques minutes' },
        'product.ask_whatsapp_badge':  { fr: 'Réponse rapide' },
        ...
        'product.reviews_kicker':      { fr: 'Communauté' },
        'product.reviews_title':       { fr: 'Avis Clients' },
        'product.reviews_write_btn':   { fr: 'Écrire un avis <i class="fas fa-pen text-[10px]"></i>' },
        'product.reviews_write_btn_2': { fr: '<i class="fas fa-star" style="font-size:0.7rem;"></i> Écrire un avis' },
        'product.reviews_overall':     { fr: 'Note globale' },
        'product.reviews_be_first':    { fr: 'Soyez le premier à donner votre avis' },
        'product.reviews_verified':    { fr: 'Avis clients vérifiés' },
        'product.reviews_write_title': { fr: 'Écrire un avis' },
        'product.reviews_star_error':  { fr: 'Veuillez sélectionner une note.' },
        'product.reviews_placeholder': { fr: 'Partagez vos impressions sur l’odeur, la tenue, l’emballage…' },
        'product.reviews_submit':      { fr: 'Soumettre l\'avis <i class="fas fa-arrow-right" style="font-size:0.65rem;"></i>' },
        'product.reviews_no_reviews':  { fr: 'Aucun avis pour le moment' },
        'product.reviews_no_reviews_sub': { fr: 'Soyez le premier à partager votre expérience avec ce parfum.' },
        'product.reviews_leave_title': { fr: 'Laisser un avis' },
        'product.reviews_need_account': { fr: 'Vous devez avoir un compte pour partager votre expérience avec ce parfum.' },
        'product.reviews_sign_in':     { fr: 'Se connecter' },
        'product.reviews_create_account': { fr: 'Créer un compte' },
